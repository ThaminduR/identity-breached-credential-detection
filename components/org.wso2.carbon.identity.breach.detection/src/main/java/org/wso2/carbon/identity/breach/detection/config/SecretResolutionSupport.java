 ...
 * <p>
 * Isolated in its own class so that a deployment without a usable secure vault degrades to literal values
 * rather than failing to load the configuration layer outright.
 */
